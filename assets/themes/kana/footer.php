        ...
        <div class="col4">
        	<div class="footerbox">
               ...
               <p> Maps: <a href="https://www.google.com/maps/dir/-6.274164,%20106.820994" target="_blank">-6.274164, 106.820994</a><br />
                ...
                <div class="socialmed">
                    <a href="https://www.facebook.com/kanaciptamedia?ref=bookmarks" target="_blank"><span class="icon-facebook2"></span></a>
                    <a href="https://twitter.com/kanadigital" target="_blank"><span class="icon-twitter2"></span></a>
                    <a href="https://www.linkedin.com/company/kanadigital" target="_blank"><span class="icon-linkedins">in</span></a>
                </div><!-- END .socialmed -->
            </div><!-- END .footerbox -->
        </div><!-- END .col4 -->
...
<p class="copylt">Kana is A Digital Innovation Agency</p>
<p class="copylb">&copy; 2014, Kana Digital Agency Indonesia & Philippines</p>
<?php
if ( is_home() ) { ?>
