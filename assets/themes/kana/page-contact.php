...
<div id="redPage">
	...
	if (isset($_POST['sendCV'])=="sendCV") {
		...
		$email_to = "narendra.wicaksana@kana.co.id,arfina@kana.co.id,ridwan@kana.co.id";
		//$email_to = "ridwan@kana.co.id,ridwan@sonar.id";
...
//				echo "<div class='overlays'><div class='messagebox'><h3>Thank you for the application. We will contact you shortly.</h3></div></div>";
//			}else{
...
if (strcasecmp('jimos4581rt@hotmail.com',trim($_POST['youremail']))!=0) {
				...
				<div class="careerForm w700">
						...
						<form class="submitcv" id="careers_form" method="POST" action="" enctype="multipart/form-data">
							<fieldset>
								...
								<div class="row">
									<textarea placeholder="Say what you need to say"  id="message" name="message"></textarea>
								</div>
								<div class="row">
                                	<div class="selectcss">
