...
// built-in functions
	...
	{
		wp_register_script('jquery1'			, THEMELINK.'/admin/js/jquery-1.9.1.js');
		wp_register_script('jqueryui'		, THEMELINK.'/admin/js/jquery-ui.js');
		...
		wp_register_script('admin'	, THEMELINK.'/admin/js/admin.js');
	...
	{
		?>
        <script type="text/javascript" src="<?php echo THEMELINK; ?>/admin/js/script.php?upload=200"></script>
        <?php
	}
	...
	function eurekaAdminRegisterCSS()
	{
		...
		wp_register_style('colpick'			, THEMELINK.'/admin/css/colpick.css');
